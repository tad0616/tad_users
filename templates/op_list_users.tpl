...
<table class="table table-hover table-striped">
    <tr>
        <th class="c"><{$smarty.const._MA_TADUSERS_DEL}></th>
        <th class="c">uid</th>
        <th class="c"><{$smarty.const._MA_TADUSERS_NAME}></th>
        <th class="c"><{$smarty.const._MA_TADUSERS_UNAME}></th>
        <th class="c">Email</th>
        <th class="c n"><{$smarty.const._MA_TADUSERS_TIMEZONE}></th>
        <th class="c"><{$smarty.const._MA_TADUSERS_LASTLOGIN}></th>
        <th class="c" data-toggle="tooltip" title="<{$smarty.const._MA_TADUSERS_ICQ}>">icq</th>
        <!-- <th class="c" data-toggle="tooltip" title="user_yim <{$smarty.const._MA_TADUSERS_COL}>">yim</th>
        <th class="c" data-toggle="tooltip" title="user_msnm <{$smarty.const._MA_TADUSERS_COL}>">msnm</th> -->
        <th class="c" data-toggle="tooltip" title="<{$smarty.const._MA_TADUSERS_OCC}>">occ</th>
        <th class="c" data-toggle="tooltip" title="<{$smarty.const._MA_TADUSERS_INTREST}>">intrest</th>
        <th class="c" data-toggle="tooltip" title="<{$smarty.const._MA_TADUSERS_BIO}>">bio</th>
