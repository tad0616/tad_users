...
<form action="main.php" method="post" id="myForm" class="mb-4">
    ...
    <table class="table table-hover table-striped">
        ...
        <tr>
            ...
            <td class="c">
                <{if $user.user_intrest or $uname|strpos:"_line" or $user.uname|strpos:"_fb" or $user.uname|strpos:"_goo" or $user.uname|strpos:"_ya"}>
            ...
            <td class="c"><input type="text" name="bio" id="bio" class="form-control " value="<{$user.bio}>"></td>
            <td class="c">
